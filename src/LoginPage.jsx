...
<div style="max-width: 600px; margin: 3rem auto; padding: 2rem; font-family: sans-serif; color: #333;">
  <h1 style="font-size: 2rem; margin-bottom: 1rem;">🪞 Welcome to <strong>Cognitive Mirror (Beta)</strong></h1>
  ...
  <p style="line-height: 1.6; font-size: 1rem;">It currently offers two voices:</p>
  <ul style="line-height: 1.6; font-size: 1rem; margin-left: 1.25rem;">
