...
// VOICE MAPPING - ONBOARDING TO APP FORMAT (NOW 1:1 - NO CONVERSION)
export const VOICE_MAPPING = {
  [VOICE_IDS.MARCUS]: VOICE_IDS.MARCUS,
  [VOICE_IDS.CLARA]: VOICE_IDS.CLARA,        // ✅ FIXED: was THERAPIST
  [VOICE_IDS.TONY]: VOICE_IDS.TONY,          // ✅ FIXED: was FRANK
  [VOICE_IDS.MARCUS_AURELIUS]: VOICE_IDS.MARCUS,
  [VOICE_IDS.TONY_D]: VOICE_IDS.TONY         // ✅ FIXED: was FRANK
};
